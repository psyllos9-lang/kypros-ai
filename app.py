...
# --- PAGE CONFIGURATION ---
st.set_page_config(
    page_title="ParkPulse Limassol // Instant Parking",
    page_icon="🅿️",
    layout="centered",
...
translations = {
    "Ελληνικά": {
        ...
        "subtitle": "Άμεση Κοινοτική Στάθμευση",
        ...
        "form_desc": "Επιλέξτε το σημείο σας και πατήστε το κουμπί για να εμφανιστεί αμέσως στον χάρτη:",
        "spot_label": "Επιλέξτε Οδό / Σημείο στη Λεμεσό:",
        "publish_btn": "✅ ΕΛΕΥΘΕΡΩΝΩ ΘΕΣΗ ΤΩΡΑ",
        "success_publish": "Η θέση σας μόλις δημοσιεύτηκε ζωντανά στον χάρτη!"
    },
    "English": {
        "title": "🅿️ ParkPulse Limassol",
        "subtitle": "Instant Community Parking",
        ...
        "form_desc": "Select your location and hit release to show it instantly on the map:",
        "spot_label": "Select Street / Location in Limassol:",
    ...
    "Русский": {
        ...
        "subtitle": "Мгновенная парковка сообщества",
        "tab1": "🗺️ Живая карта",
        "tab2": "🚀 Освободить",
        ...
        "form_title": "🚀 Быстрое освобождение места",
        "form_desc": "Выберите место и нажмите кнопку для публикации на карте:",
        "spot_label": "Выберите улицу / место:",
        "publish_btn": "✅ ОСВОБОДИТЬ МЕСТО СЕЙЧАС",
        "success_publish": "Ваше место успешно опубликовано на карте!"
    },
    "עברית": {
        "title": "🅿️ ParkPulse לימסול",
        "subtitle": "חניה קהילתית מיידית",
        "tab1": "🗺️ מפת חניה חיה",
        "tab2": "🚀 שחרר עכשיו",
        ...
        "form_desc": "בחר את המיקום שלך ולחץ על שחרור כדי להציג אותו מיד במפה:",
        "spot_label": "בחר רחוב / מיקום בלימסול:",
...
limassol_parking_spots = {
    "📍 Οδός Ανεξαρτησίας (Κέντρο)": {"lat": 34.70654, "lon": 33.04351},
...
with tab2:
    ...
    with st.form("instant_release", border=False):
