...
# --- PAGE CONFIGURATION ---
st.set_page_config(
    page_title="ParkPulse Limassol // Official Municipal Engine",
    page_icon="🅿️",
    layout="wide",
...
st.markdown("""
    <div class="cyber-header">
        ...
        <span class="live-badge">⚡ OFFICIAL MUNICIPAL DATA</span>
    </div>
""", unsafe_allow_html=True)
...
def load_parking_data():
    ...
    if os.path.exists(csv_file):
        ...
        data = [
            ("Αρ. 21: Χώρος Στάθμευσης ΤΕΠΑΚ", "Long Term Parking", 34.68352, 33.04512),
            ("Αρ. 5: Χριστόδουλου Χατζηπαύλου (Molos 3)", "Waterfront Parking", 34.67389, 33.04542)
        ]
...
if selected_view == "🗺️ Live Χάρτης & Αναφορά":
    ...
    # Interactive Map centered on Limassol center
    m = folium.Map(
