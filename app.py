...
st.markdown("""
    <div class="chat-header">
        <h1>Έι Άι 🇨🇾</h1>
        <p>Ο σύγχρονος ψηφιακός βοηθός σου με ζωντανή αναζήτηση</p>
    </div>
""", unsafe_allow_html=True)
...
CYPRIOT_SYSTEM_PROMPT = (
    ...
    "Όταν σου ζητούν ειδήσεις ή γεγονότα, χρησιμοποιείς τα αποτελέσματα της αναζήτησης και τα παρουσιάζεις στα κυπριακά."
)
...
if prompt := st.chat_input("Λάλε μου κάτι..."):
    ...
    with st.chat_message("assistant"):
        ...
        try:
            # Here we enable Google Search tool properly via vertex/genai tools configuration
