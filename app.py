...
# --- PAGE CONFIGURATION ---
st.set_page_config(
    page_title="ParkPulse Limassol // Fixed Map",
    page_icon="🅿️",
    layout="wide",
...
st.markdown("""
    <div class="cyber-header">
        ...
        <span class="live-badge">⚡ PRECISION GRID ENGINE</span>
    </div>
""", unsafe_allow_html=True)
...
# --- VERIFIED EXACT LIMASSOL CENTER COORDINATES ---
@st.cache_data
def load_limassol_spots():
    data = [
        ("Αρ. 21: Χώρος Στάθμευσης ΤΕΠΑΚ", "Municipal Long Term", 34.6853, 33.0450),
        ("Αρ. 54: Σπύρου Αραούζου (Μόλος)", "Waterfront Parking", 34.6760, 33.0510),
        ("Αρ. 55: Χριστόδουλου Χατζηπαύλου (Μόλος)", "Waterfront Parking", 34.6740, 33.0460),
        ("Αρ. 10: Παλιό Λιμάνι", "Hub Parking", 34.6710, 33.0370),
        ("Αρ. 8: Εναέριος (Μακαρίου)", "Long Term Parking", 34.6880, 33.0520),
        ("Αρ. 1: Ανδρέα Θεμιστοκλέους", "Long Term Parking", 34.6860, 33.0410),
        ("Αρ. 7: Πλησίον Δικαστηρίων", "Long Term Parking", 34.6910, 33.0440)
    ]
...
if selected_view == "🗺️ Live Χάρτης & Αναφορά":
    ...
    # Interactive Map centered precisely on Limassol center with fixed zoom 15
    m = folium.Map(
        location=[34.6800, 33.0420], 
        zoom_start=15, 
    ...
    st.markdown("""
        <div class="interactive-card">
            ...
            <p style="font-size: 0.8rem; color: #94a3b8; margin-bottom: 0;">
                Βάσει των επίσημων δεδομένων του Δήμου Λεμεσού:
                <br><br>
    ...
    st.info("Οι επίσημοι δημοτικοί χώροι στάθμευσης προσφέρουν σταθερά την καλύτερη διαθεσιμότητα στο κέντρο.")
