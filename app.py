...
# --- 100% VERIFIED CORE LOCATIONS IN LIMASSOL ---
@st.cache_data
def load_limassol_spots():
    data = [
        ("Molos Multi-Storey Parking", "Multi-story Structure", 34.6751, 33.0478),
        ("Limassol Marina Parking", "Covered / Structured", 34.6715, 33.0402),
        ("Limassol Old Port Parking", "Off-Street Hub", 34.6708, 33.0375),
        ("Anexartisias Street Parking Zone", "On-Street Zones", 34.6815, 33.0412)
    ]
...
if selected_view == "🗺️ Live Χάρτης & Αναφορά":
    ...
    # Interactive Map centered precisely on the heart of Limassol with high zoom (16)
    m = folium.Map(
        location=[34.6750, 33.0420], 
        zoom_start=16, 
