...
# --- PAGE CONFIGURATION (Full screen & no default menu) ---
st.set_page_config(
...
# --- ADVANCED CYBER-TECH STYLING & HEADER REMOVAL ---
# This CSS removes the default Streamlit padding and header, creating a full-app feel.
# It also introduces a custom, high-tech title bar and clean input elements.
st.markdown("""
    <style>
    @import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&display=swap');

    /* Remove Streamlit default top header padding */
    #stMainBlockContainer {
        padding-top: 0rem;
    }
    /* Hide the main Streamlit header */
    ...
    /* Custom High-Tech Header Bar */
    .custom-header {
        background: #111827;
        border-bottom: 1px solid #1f2937;
        padding: 1rem 2rem;
        margin: -3rem -4rem 2rem -4rem; /* Extend to full width */
        display: flex;
    ...
    section[data-testid="stSidebar"] .stMarkdown h3 {
        color: #38bdf8; /* Highlight sidebar headers */
        font-weight: 700;
    }
    
    /* Custom Styling for Selectboxes and Sliders */
    .stSelectbox > div > div {
...
# --- CUSTOM HIGH-TECH HEADER RENDER ---
st.markdown("""
    <div class="custom-header">
        <div>
            <h1 class="header-title">⚡ E-Hub Cyprus</h1>
            <p class="header-subtitle">Advanced EV Charging & Cost Intelligence Network</p>
        </div>
        <div>
...
if app_mode == "🗺️ Live Network Map":
    ...
    # --- ENHANCED MAP WITH CORRECT THEME ---
    # We use CartoDB Voyager, which is clean and neutral (no political watermarks).
    m = folium.Map(location=[35.1264, 33.4251], zoom_start=10, tiles="CartoDB voyager")
