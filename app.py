...
# --- FUTURISTIC & MOBILE-FRIENDLY STYLING ---
st.markdown("""
    <style>
    .block-container {
...
st.markdown("""
    <div class="cyber-header">
        <div>
            ...
            <h1 class="cyber-title">🅿️ ParkPulse AI</h1>
        </div>
        <div>
            <span class="live-badge">⚡ LIVE HYBRID</span>
        </div>
    </div>
""", unsafe_allow_html=True)
...
if selected_view == "🗺️ Live Χάρτης & Αναφορά":
    ...
    # --- SUPER FRIENDLY MOBILE LIVE REPORT WIDGET ---
    st.markdown("""
        <div class="interactive-card">
            <h3 style="color: #38bdf8; margin-top: 0; font-size: 1.05rem;">📍 Είσαι σε πάρκινγκ τώρα;</h3>
            <p style="font-size: 0.75rem; color: #94a3b8; margin-bottom: 0.8rem;">Δώσε μια γρήγορη αναφορά για να βοηθήσεις τους οδηγούς πίσω σου!</p>
        </div>
    """, unsafe_allow_html=True)
    ...
    if st.button("🚀 Άμεση Ενημέρωση Χάρτη", use_container_width=True):
