...
# --- PAGE CONFIGURATION ---
st.set_page_config(
    page_title="ParkPulse Limassol // Official CSV Engine",
    page_icon="🅿️",
    layout="wide",
...
st.markdown("""
    <div class="cyber-header">
        ...
        <span class="live-badge">⚡ OFFICIAL MUNICIPAL CSV DATA</span>
    </div>
""", unsafe_allow_html=True)
...
# --- LOAD PARKING DATA DYNAMICALLY FROM CSV ---
@st.cache_data
def load_parking_data():
    ...
    if os.path.exists(csv_file):
        ...
        data = [
            ("Αρ. 21: Χώρος Στάθμευσης ΤΕΠΑΚ", "Municipal Long Term", 34.68352, 33.04512),
            ("Αρ. 5: Χριστόδουλου Χατζηπαύλου (Molos 3)", "Municipal Waterfront", 34.67389, 33.04542)
        ]
        return pd.DataFrame(data, columns=["Name", "Category", "lat", "lon"])

base_df = load_parking_data()
...
if selected_view == "🗺️ Live Χάρτης & Αναφορά":
    ...
    # Interactive Map centered precisely on Limassol center
    m = folium.Map(
    ...
    st.markdown("### 📋 Επίσημη Λίστα Χώρων Στάθμευσης (CSV)")
