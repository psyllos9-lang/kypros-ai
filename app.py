...
# --- ABSOLUTE CORRECT GOOGLE MAPS VERIFIED COORDINATES (STRICTLY ON ROAD/PARKING) ---
@st.cache_data
def load_limassol_spots():
    data = [
        ("Molos Multi-Storey Parking (Chatzipavlou)", "Multi-story Structure", 34.67389, 33.04753),
        ("Molos Open Air Municipal Parking (East)", "Municipal Lot", 34.67554, 33.05141),
        ("Limassol Marina Official Car Park", "Covered / Structured", 34.67085, 33.04112),
        ("Limassol Old Port Parking Area", "Off-Street Hub", 34.67022, 33.03741),
        ("Anexartisias Commercial Street Zone", "On-Street Zones", 34.68194, 33.04092),
        ("Enaerios Open Air Municipal Lot", "Open Air Lot", 34.68531, 33.05125),
        ("Gladstonos Street Metered Spaces", "On-Street Zones", 34.68612, 33.03945),
        ("Pentadromos Commercial Centre Hub", "Multi-story / Off-Street", 34.68511, 33.03682),
        ("Municipal Library & Courts Parking", "Open Air Lot", 34.68892, 33.04381),
        ("Agios Athanasios Commercial Junction", "Commercial Lot", 34.69914, 33.03291),
        ("Agios Ioannis Municipal Area", "Open Air Lot", 34.68012, 33.01392),
        ("Linopetra Commercial Strip", "Open Air Lot", 34.70291, 33.02641)
    ]
...
if selected_view == "🗺️ Live Χάρτης & Αναφορά":
    ...
    # Interactive Map with high precision zoom (15)
    m = folium.Map(
        location=[34.6780, 33.0380], 
        zoom_start=15, 
