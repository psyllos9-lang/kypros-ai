...
st.markdown("""
    <div class="cyber-header">
        <div class="cyber-title">🅿️ ParkPulse Limassol - Official Municipal Map</div>
        <span class="live-badge">⚡ BASED ON MUNICIPAL DATA</span>
    </div>
""", unsafe_allow_html=True)
...
# --- OFFICIAL MUNICIPAL PARKING SPOTS (BASED ON MUNICIPALITY MAP & DATA) ---
@st.cache_data
def load_limassol_spots():
    data = [
        ("Αρ. 1: Οδός Ανδρέα Θεμιστοκλέους", "Long Term Parking", 34.68532, 33.04125),
        ("Αρ. 2: Οδός Ανδρέα Βλάμη", "Long Term Parking", 34.68712, 33.04251),
        ("Αρ. 5: Οδός Ηπείρου", "Long Term Parking", 34.68815, 33.04412),
        ("Αρ. 8: Οδός Οθόνης και Αμαλίας", "Long Term Parking", 34.69012, 33.05312),
        ("Αρ. 10: Οδός Ρένου Πουγιούκκα", "Long Term Parking", 34.68412, 33.03712),
        ("Αρ. 21: Χώρος Στάθμευσης ΤΕΠΑΚ (Γεωργίου Γενναδίου)", "Long Term Parking", 34.68352, 33.04512),
        ("Αρ. 54: Σπύρου Αραούζου (Μόλος)", "Long Term Parking", 34.67512, 33.04891),
        ("Αρ. 55: Χριστόδουλου Χατζηπαύλου (Μόλος)", "Long Term Parking", 34.67389, 33.04542),
        ("Αρ. 10 (Old Port): Σπύρου Αραούζου (Παλιό Λιμάνι)", "Long Term Parking", 34.67105, 33.03712),
        ("Αρ. 8 (Enaerios): Λεωφόρος Μακαρίου ΙΙΙ (Εναέριος)", "Long Term Parking", 34.68692, 33.05185),
        ("Αρ. 7 (Court): Εμ. Ροΐδη (Πλησίον Δικαστηρίων)", "Long Term Parking", 34.69124, 33.04512)
    ]
...
if selected_view == "🗺️ Live Χάρτης & Αναφορά":
    ...
    st.info("Οι επίσημοι δημοτικοί χώροι στάθμευσης γύρω από το ΤΕΠΑΚ και τον Μόλο προσφέρουν σταθερά την καλύτερη διαθεσιμότητα.")
