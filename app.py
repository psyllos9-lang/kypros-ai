...
CYPRIOT_SYSTEM_PROMPT = (
    "Εσείσαι ένας σύγχρονος, φιλικός και ντόπιος Κύπριος. "
    ...
    "Απαγορεύεται αυστηρά να χρησιμοποιείς αρχαίες, λόγιες, ξένες ή ψεύτικες/υπερβολικές εκφράσεις (όπως το 'έρρενς'). "
    "Ο λόγος σου είναι απλός, άμεσος, καθαρός και κυπριακός, ακριβώς όπως μιλάει ένας κανονικός άνθρωπος σήμερα."
)
...
if prompt := st.chat_input("Λάλε μου κάτι..."):
    ...
    with st.chat_message("assistant"):
        ...
        message_placeholder.markdown("*Γράφει...*")
