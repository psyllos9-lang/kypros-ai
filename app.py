...
# --- CLEANED AND RE-ALIGNED LIMASSOL CENTER COORDINATES ---
@st.cache_data
def load_limassol_spots():
    data = [
        ("Molos Multi-Storey Parking", "Multi-story Structure", 34.6750, 33.0470),
        ("Limassol Marina Parking", "Covered / Structured", 34.6720, 33.0400),
        ("Limassol Old Port Parking", "Off-Street Hub", 34.6710, 33.0370),
        ("Anexartisias Street Zone", "On-Street Zones", 34.6820, 33.0410),
        ("Enaerios Municipal Parking", "Open Air Lot", 34.6860, 33.0510),
        ("Gladstonos Street Spaces", "On-Street Zones", 34.6870, 33.0400),
        ("Pentadromos Centre Hub", "Multi-story / Off-Street", 34.6850, 33.0370),
        ("Municipal Library Parking", "Open Air Lot", 34.6900, 33.0440),
        ("Agios Athanasios Junction", "Commercial Lot", 34.7000, 33.0330)
    ]
...
if selected_view == "🗺️ Live Χάρτης & Αναφορά":
    ...
    # Interactive Map centered strictly on Limassol city center with zoom 15
    m = folium.Map(
