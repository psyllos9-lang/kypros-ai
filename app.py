...
# --- 100% VERIFIED LAND-ONLY COORDINATES (LIMASSOL CENTRE) ---
@st.cache_data
def load_limassol_spots():
    data = [
        ("Molos Municipal Parking (Christodoulou Chatzipavlou)", "Municipal / Off-Street", 34.6738, 33.0452),
        ("Molos Multi-Storey Parking Hub", "Multi-story Structure", 34.6775, 33.0478),
        ("Anexartisias Commercial Street Zone", "On-Street Zones", 34.6815, 33.0420),
        ("Enaerios Open Air Municipal Lot", "Open Air Lot", 34.6862, 33.0505),
        ("Limassol Old Port Visitor Parking", "Off-Street Hub", 34.6715, 33.0375),
        ("Limassol Marina North Structured Parking", "Covered / Structured", 34.6750, 33.0402),
        ("Municipal Library & Courts Parking", "Open Air Lot", 34.6890, 33.0430),
        ("Gladstonos Street Metered Spaces", "On-Street Zones", 34.6865, 33.0398),
        ("Pentadromos Commercial Centre Hub", "Multi-story / Off-Street", 34.6852, 33.0365),
        ("Agios Athanasios Commercial Junction", "Commercial Lot", 34.6980, 33.0330),
        ("Agios Ioannis Municipal Area", "Open Air Lot", 34.6805, 33.0135),
        ("Linopetra Commercial Strip", "Open Air Lot", 34.7025, 33.0265)
    ]
