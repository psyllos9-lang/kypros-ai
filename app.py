...
# --- ACCURATE REAL-WORLD LIMASSOL COORDINATES ---
limassol_parking_spots = {
    "📍 Οδός Ανεξαρτησίας (Κέντρο Εμπορικό)": {"lat": 34.67718, "lon": 33.04510},
    "📍 Οδός Αγίου Ανδρέου (Ιστορικό Κέντρο)": {"lat": 34.67377, "lon": 33.04358},
    "📍 Περιοχή Μώλος / Αποβάθρα": {"lat": 34.67660, "lon": 33.05030},
    "📍 Οδός Σαριπόλου (Bar Street)": {"lat": 34.67468, "lon": 33.04368},
    "📍 Πλατεία Ηρώων (ΕΠΑΛ)": {"lat": 34.67890, "lon": 33.04520},
    "📍 ΕΝΑΕΡΙΟΣ (Παραλιακή Λεωφόρος)": {"lat": 34.68520, "lon": 33.06740},
...
with tab1:
    ...
    # Center map accurately over Limassol center
    limassol_map = folium.Map(location=[34.6751, 33.0443], zoom_start=15, tiles="CartoDB dark_matter")
