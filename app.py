...
# --- CORRECTED LIMASSOL PARKING DATABASE (Strictly on Land) ---
@st.cache_data
def load_limassol_spots():
    data = [
        ("Molos Multistore Parking (East)", "Municipal / Multi-story", 34.6752, 33.0485),
        ("Molos Park Central Area", "Open Air Lot", 34.6770, 33.0535),
        ("Enaerios Municipal Parking Area", "Open Air Lot", 34.6881, 33.0530),
        ("Anexartisias Commercial Strip", "On-Street Zones", 34.6825, 33.0410),
        ("Limassol Old Port Visitor Parking", "Off-Street Hub", 34.6730, 33.0395),
        ("Limassol Marina North Parking", "Covered / Structured", 34.6755, 33.0425),
        ("Municipal Library Parking Lot", "Open Air Lot", 34.6905, 33.0440),
